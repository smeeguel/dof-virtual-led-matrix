...
### Step 1B - Copy the package config files
...
1. From the package root, run `DOFConfigSetup.bat`.
...
- Access denied/copy failed: run `DOFConfigSetup.bat` as Administrator, then try again.
- Script blocked by Windows: right-click `DOFConfigSetup.bat`, choose **Run anyway**.
...
If you already ran `DOFConfigSetup.bat` in Step 1C and your virtual matrix is working, you can skip this section.
