...
public sealed class InstallerState : INotifyPropertyChanged
{
    ...
    private bool _openInstructionsAfterInstall;
    ...
    public bool   OpenInstructionsAfterInstall { get => _openInstructionsAfterInstall; set => Set(ref _openInstructionsAfterInstall, value); }
