...
namespace DracLabs
{
    public class IniFile
    {
        ...
        // SectionList - Preserves the original order of the sections
        public ArrayList SectionList
        {
            get { return a_sections; }
        }
