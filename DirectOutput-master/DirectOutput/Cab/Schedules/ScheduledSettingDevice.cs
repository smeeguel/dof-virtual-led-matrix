...
namespace DirectOutput.Cab.Schedules {
    public class ScheduledSettingDevice:INamedItem {

        public ScheduledSettingDevice() { }

        public ScheduledSettingDevice(string Name, int ConfigPostfixID, string Outputs, int OutputPercent) :this() {
            Log.Write("ScheduledSettingDevice constructor...name=" + Name);
            this.Name = Name;
