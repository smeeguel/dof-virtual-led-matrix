    ...
    public class PacUIO : OutputControllerBase, IOutputController
    {
        ...
        private class PacUIOUnit
        {
            ...
            private void PacUIOUpdaterDoIt()
            {
                ...
                {
                    Log.Exception("A exception occurred while setting the fadetime for PacUIO {0} to 0.".Build(Index), E);
                    throw;
                }
                int FailCnt = 0;
                while (KeepPacUIOUpdaterAlive)
                {
                    ...
                    {
                        Log.Exception("A error occurred when updating PacUIO {0}".Build(Id), E);
