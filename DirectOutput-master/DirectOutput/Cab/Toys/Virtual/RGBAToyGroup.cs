...
{
    /// <summary>
    /// This toys allows the grouping of several RGBA toys (e.g. <see cref="RGBAToy"/> or <see cref="DirectOutput.Cab.Toys.Hardware.RGBLed"/>) into a matrix, which can be controlled by the matrix effects.
    /// 
