...
public partial class SettingsWindow : Window
{
    ...
    private void UpdateSelectionTooltips()
    {
        ...
        {
            VisualQualityProfiles.Low => "Low: fastest flat RGB pass in Vulkan renderer, no bulb/specular, no temporal smoothing, no tone mapping.",
            VisualQualityProfiles.Medium => "Medium: Vulkan renderer with bulb effect, no heavy post-processing.",
            VisualQualityProfiles.High => "High: Vulkan renderer with tone mapping + temporal smoothing.",
